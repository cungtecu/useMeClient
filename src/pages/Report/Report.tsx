    ...
    <Spin spinning={getAllReportAPI.loading}>
      <div className="m-4">
        ...
        <div className="text-xl font-medium mb-4">
          Tổng Doanh Thu: {" "}
          <span className="text-blue-500 ml-1">
            {((report?.takeawayReport?.[0]?.totalAmount?? 0) + (report?.nonTakeawayReport?.[0]?.totalAmount?? 0)).toLocaleString()} VND
          </span>
        </div>
        <div className="text-xl font-medium mb-4">
          {/* Tổng doanh thu:{" "}
          ...
          Tổng Lợi Nhuận: {" "}
          <span className="text-blue-500 ml-1">
            {((report?.takeawayReport?.[0]?.totalAmount?? 0) + (report?.nonTakeawayReport?.[0]?.totalAmount?? 0) - (report?.totalCostIn ?? 0)).toLocaleString()} VND
          </span>
        </div>
